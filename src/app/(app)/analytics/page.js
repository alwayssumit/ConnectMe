              ...
              {page.links.map(link=>(
                ...
                className="md:flex gap-4 items-center border-t border-gray-200 py-4">
                  ...
                  <div className="grow">
                     ...
                     <a href="link.url" className="text-xs text-blue-400" terget="_blank">{link.url}</a>
                  </div>
                  <div className="text-center">
                    <div className="border rounded-md p-2 md:mt-0">
                      <div className="text-3xl">
                        {clicks.filter(c=> c.uri === link.url && isToday(c.createdAt)).length}<br/>
                     </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-3xl">
                    ...
                    <div className="uppercase font-bold text-xs text-gray-400">Clicks total</div>
                  </div>
